...
const isVerticalMix = computed(() => props.layoutMode || themeStore.layout.mode === "vertical-mix")
const isHorizontalMix = computed(() => props.layoutMode || themeStore.layout.mode === "horizontal-mix")
